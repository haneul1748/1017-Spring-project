...
public class ApiService {
	...
	public String requestBeef() {
		...
		final String API_KEY = "54b1890dc8ae18f69f97c7cef5be2343ce6ded4077e3e0ce5ca0b32d866a4375";
	...
	public String requestBlog(String query) {
        String clientId = "1IQ5BgSaHuVrC9wMWmTE"; //애플리케이션 클라이언트 아이디
        String clientSecret = "Ju5Y9q2Fe5"; //애플리케이션 클라이언트 시크릿
        ...
        String apiURL = "https://openapi.naver.com/v1/search/shop?query=" + text + "&start=2&sort=date";    // JSON 결과
