...
<body>
	...
	<div class="innerOuter">
		...
		* 핵심!! => 비동기통신 => 부분갱신 => 사용자 경험 향상 => 트래픽줄어듬
		...
		-success : AJAX 통신 성공 시 수행할 함수를 정의		
				
 	</pre>

		<h3>1. 버튼을 클릭해서 GET방식으로 요청 보내서 데이터 받아서 화면에 출력!</h3>
		...
		<div class="form-group">
			...
			<div class="form-control">
				<button class="btn btn-sm btn-success" id="ajax-btn"
					onclick="test1();">AJAX로 요청 보내기</button>
			</div>
		</div>
		...
		<!-- 계획 :
		 ...
		 받은 응답데이터 라벨요소 Content영역에 출력할 것 
	...
	<br>
	게시글 번호를 입력해주세요 : <input type="text" id="detail" />
			...
			$.ajax({
				...
				success : result => {
					...
					const el = replies.map(e => {
						return (
								`<div>
									<label style="300px">댓글 작성자 : \${ e.replyWriter }</label>
